...
public class MainActivity extends AppCompatActivity {
    private static final String PREFS = "pncmod_prefs";
    ...
    private static final String PNCMOD_FOLDER = "PnCmod";
    ...
    private void doRestore() {
        try {
            ...
            File pncmodDir = new File(Environment.getExternalStorageDirectory(), PNCMOD_FOLDER);
            File backup = new File(pncmodDir, BACKUP_NAME);
            if (!backup.exists()) {
    ...
    private void initializeExternalFiles() {
        ...
        try {
            ...
            File presetsFile = new File(pncmodDir, PRESETS_FILE);
            ...
            // Copy asset file to PnCmod folder for easy access
            File assetFile = new File(pncmodDir, ASSET_NAME);
            if (!assetFile.exists()) {
            ...
            String message = "PnCmod files created at:\n/sdcard/" + PNCMOD_FOLDER + "/";
            updateStatus(message);
            toast("Setup complete! Check /sdcard/PnCmod/");
        } catch (IOException e) {
    ...
    private void launchAutoClicker() {
        ...
        if (AutoClickerAccessibilityService.getInstance() == null) {
            ...
            startActivity(intent);
            toast("Please enable PnCmod Accessibility Service");
            return;
        }
